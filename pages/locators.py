...
class BasePageLocators():
    LOGIN_LINK = (By.CSS_SELECTOR, "#login_link")
    LOGIN_LINK_INVALID = (By.CSS_SELECTOR, "#login_link") #поменял селектор на корректный чтобы соотв тест выполнился так как это требуется в финальном задании, был #login_link_inc
